...
export const routes = [
  ...
  { path: '/sobre/', page: 'about', className: 'about-page', title: 'Sobre Gislaine Duarte | História, formação e cuidado', description: 'Conheça a história de Gislaine Duarte, nutricionista e empreendedora, sua formação e o cuidado com mulheres e famílias orientado pela ciência e pela escuta.', crumbs: [initial, { name: 'Sobre a Gi', href: '/sobre/' }] },
