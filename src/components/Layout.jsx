...
export function ContactBand({ service }) {
  return <section className="contact-band" aria-labelledby="contact-title"><BrandMark className="contact-band__symbol" mono /><div className="shell contact-band__inner"><div data-reveal><p className="eyebrow">Seu próximo passo</p><h2 id="contact-title">Vamos conversar<br />sobre <em>você?</em></h2></div><div className="contact-band__actions" data-reveal><p>Cuidar da alimentação pode começar com uma conversa. Conheça as possibilidades de atendimento para o seu momento.</p><Button href={contactLink(service)} external>{service ? 'Solicitar orçamento' : contactLabel}</Button></div></div></section>;
}
